...
int homeFrame[] = {500,500,1400,1500,1500,1500,1400,1500,1450,1500,1450,1500};
...
int Frame_step1_1[] = {1400,1500,1400,1500,1800,2500,1400,1500,1450,1500,1450,1500};

///Step1.2
int channel_step1_2[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_2[] = {1400,1500,1400,1500,1800,1500,1400,1500,1450,1500,1450,1500};

////Step 1.3
int channel_step1_3[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_3[] = {1400,1500,1700,500,1800,1500,1400,1500,1450,1500,1450,1500};

////Step 1.4
int channel_step1_4[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_4[] = {1400,1500,1700,1500,1800,1500,1400,1500,1450,1500,1450,1500};

////Step 1.5
int channel_step1_5[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_5[] = {1700,2500,1700,1500,1800,1500,1400,1500,1450,1500,1450,1500};

///Step1.6
int channel_step1_6[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_6[] = {1700,1500,1700,1500,1800,1500,1400,1500,1450,1500,1450,1500};

////Step 1.7 1150 changed to 1250
int channel_step1_7[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_7[] = {1700,1500,1700,1500,1800,1500,1400,1500,1450,1500,1250,500};

////Step 1.8
int channel_step1_8[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_8[] = {1700,1500,1700,1500,1800,1500,1400,1500,1450,1500,1250,1500};

////Step 1.9 1150 to 1250
int channel_step1_9[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_9[] = {1700,1500,1700,1500,1800,1500,1400,1500,1250,2500,1250,1500};

///Step1.10
int channel_step1_10[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_10[] = {1700,1500,1700,1500,1800,1500,1400,1500,1250,1500,1250,1500};

////Step 1.11 1100 to 1200
int channel_step1_11[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_11[] = {1700,1500,1700,1500,1800,1500,1200,500,1250,1500,1250,1500};

////Step 1.11
int channel_step1_12[] = {0,1,2,3,14,15,16,17,24,25,30,31};
int Frame_step1_12[] = {1700,1500,1700,1500,1800,1500,1200,500,1250,1500,1250,1500};
